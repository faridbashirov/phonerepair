...
const Faq = () => {
  ...
  return (
    <div className=' h-auto lg:h-[1000px] py-20 px-10'>
        <div className='w-[95%] mx-auto flex flex-col lg:flex-row  justify-between   '>
           ...
           <VscTools className='text-4xl text-[#f2480c]'/>

           <h2 className='text-3xl'>Read FAQ’s</h2>
           <p>Your all questions are answered here about our services.</p>
           </div>
           <div className='dropdown h-[700px] flex flex-col  '>
            ...
            <div className='form bg-[#22282e] text-white h-[700px] w-[100%] lg:w-[50%] rounded-xl py-20 px-5 flex flex-col items-center  '>
                <h2 className='text-3xl my-3 w-[400px] '>
                Do you still have more
                 questions? Send us!
                </h2>
                <form className='flex flex-col mt-2 justify-between w-[100%] bg-[#22282e] h-[500px] '>
                    ...
                    <button className=' py-2  border-4 border-[#f2480c]' type='submit'>Send</button>
                </form>
