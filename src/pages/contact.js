    ...
    <div className='w-full'>
      ...
      />
            <div className='w-full lg:w-[45%] text-start '>
                 ...
                 <div className='mb-5'><BsEnvelope className='text-[27px] mr-2 text-gray-500 '/> <Link to="mailto:phonerepair.aj@gmail.com" className='text-lg font-medium  text-gray-500 hover:text-[#f2480c]'>phonerepair.aj@gmail.com</Link></div>
