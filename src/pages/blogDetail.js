            ...
            <div className='w-[90%] mx-auto flex lg:flex-row flex-col justify-between mt-10'>
                <div className='flex flex-col w-[full]   lg:w-full  items-center'>
                    ...
                    <div className='blog-detail flex flex-col w-full  shadow-lg-1000 '>
                        <img alt='image' className='w-full h-[250px] lg:h-[500px] mb-5' src='https://images.unsplash.com/photo-1485470733090-0aae1788d5af?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1517&q=80' />
